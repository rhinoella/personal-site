export const Contact = () => {
  return (
    <div
      id="contact"
      className="h-72 bg-foreground p-10 flex flex-col justify-between"
    >
      <div>
        <h1 className="text-lg font-mono-numbers pb-6">CONTACT</h1>
        <div className="flex flex-col gap-4">
          <div className="flex flex-row gap-2">
            ...
            <p className="font-light">noella.spitz@gmail.com</p>
          </div>
      ...
      <p className="font-extralight">&copy; Noella Spitz 2024</p>
    </div>
  );
};
